(() => {
    ...
    da.init();
    function typeTextOnScroll() {
        const elementsWithDataTextType = document.querySelectorAll("[data-text-type]");
        elementsWithDataTextType.forEach((function(element) {
            const words = element.innerText.trim().split(/\s+/);
            let newText = "";
            words.forEach((function(word) {
                newText += '<span class="word"><span class="visible">' + word.split("").join('</span><span class="visible">') + "</span></span> ";
            }));
        ...
        const observer = new IntersectionObserver((function(entries) {
            entries.forEach((function(entry) {
                if (entry.isIntersecting) {
                    ...
                    const spans = element.querySelectorAll(".visible");
    ...
    setTimeout(typeTextOnScroll, 100);
    window["FLS"] = true;
    addLoadedClass();
    menuInit();
    formFieldsInit({
